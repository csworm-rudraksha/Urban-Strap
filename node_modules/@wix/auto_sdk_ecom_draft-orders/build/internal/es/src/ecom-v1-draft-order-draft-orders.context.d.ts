...
export declare const updateLineItems: MaybeContext<BuildRESTFunction<typeof publicUpdateLineItems> & typeof publicUpdateLineItems>;
export declare const setDiscounts: MaybeContext<BuildRESTFunction<typeof publicSetDiscounts> & typeof publicSetDiscounts>;
export declare const createCustomDiscounts: MaybeContext<BuildRESTFunction<typeof publicCreateCustomDiscounts> & typeof publicCreateCustomDiscounts>;
export declare const deleteCustomDiscounts: MaybeContext<BuildRESTFunction<typeof publicDeleteCustomDiscounts> & typeof publicDeleteCustomDiscounts>;
export declare const setAdditionalFees: MaybeContext<BuildRESTFunction<typeof publicSetAdditionalFees> & typeof publicSetAdditionalFees>;
export declare const createCustomAdditionalFees: MaybeContext<BuildRESTFunction<typeof publicCreateCustomAdditionalFees> & typeof publicCreateCustomAdditionalFees>;
export declare const deleteCustomAdditionalFees: MaybeContext<BuildRESTFunction<typeof publicDeleteCustomAdditionalFees> & typeof publicDeleteCustomAdditionalFees>;
export declare const setShippingInfo: MaybeContext<BuildRESTFunction<typeof publicSetShippingInfo> & typeof publicSetShippingInfo>;
export declare const setBuyerInfo: MaybeContext<BuildRESTFunction<typeof publicSetBuyerInfo> & typeof publicSetBuyerInfo>;
export declare const setRecipientInfo: MaybeContext<BuildRESTFunction<typeof publicSetRecipientInfo> & typeof publicSetRecipientInfo>;
export declare const setBillingInfo: MaybeContext<BuildRESTFunction<typeof publicSetBillingInfo> & typeof publicSetBillingInfo>;
export declare const getDraftOrder: MaybeContext<BuildRESTFunction<typeof publicGetDraftOrder> & typeof publicGetDraftOrder>;
export declare const getOrderDraftabilityStatus: MaybeContext<BuildRESTFunction<typeof publicGetOrderDraftabilityStatus> & typeof publicGetOrderDraftabilityStatus>;
export declare const commitDraftOrder: MaybeContext<BuildRESTFunction<typeof publicCommitDraftOrder> & typeof publicCommitDraftOrder>;
