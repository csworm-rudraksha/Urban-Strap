 ...
 */
export declare function onProductCollectionChanged(handler: (event: ProductCollectionChangedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function onProductCollectionCreated(handler: (event: ProductCollectionCreatedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function onProductCollectionDeleted(handler: (event: ProductCollectionDeletedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function onProductChanged(handler: (event: ProductChangedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function onProductVariantsChanged(handler: (event: ProductVariantsChangedEnvelope) => void | Promise<void>): void;
/**
