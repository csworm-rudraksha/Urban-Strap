 ...
 */
export async function createInfoSection(infoSection) {
    // @ts-ignore
    ...
    try {
        ...
        return renameKeysFromRESTResponseToSDKResponse(result.data)?.infoSection;
    }
    catch (err) {
 ...
 */
export async function getInfoSection(infoSectionId, options) {
    // @ts-ignore
 ...
 */
export async function getOrCreateInfoSection(options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({
 ...
 */
export async function bulkGetOrCreateInfoSections(options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({
 ...
 */
export async function updateInfoSection(_id, infoSection, options) {
    // @ts-ignore
 ...
 */
export async function deleteInfoSection(infoSectionId) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        infoSectionId: infoSectionId,
 ...
 */
export function queryInfoSections(options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    return queryBuilder({
        func: async (payload) => {
 ...
 */
export async function bulkCreateInfoSections(infoSections, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
 ...
 */
export async function bulkUpdateInfoSections(infoSections, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        infoSections: infoSections,
 ...
 */
export async function bulkDeleteInfoSections(infoSectionIds) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({
