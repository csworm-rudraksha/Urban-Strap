...
interface CreateBackInStockNotificationRequestSignature {
     ...
     */
    (request: BackInStockNotificationRequest, itemDetails: BackInStockItemDetails): Promise<BackInStockNotificationRequest>;
}
...
interface GetBackInStockNotificationRequestSignature {
     ...
     */
    (_id: string): Promise<BackInStockNotificationRequest>;
}
...
interface MarkAsNotificationSentSignature {
     ...
     */
    (_id: string): Promise<MarkAsNotificationSentResponse>;
}
...
interface GetBackInStockNotificationRequestsCountByCatalogReferencesSignature {
     ...
     */
    (catalogReferences: CatalogReference[]): Promise<GetBackInStockNotificationRequestsCountByCatalogReferencesResponse>;
}
...
export { ActionEvent, App, BackInStockItemDetails, BackInStockNotificationRequest, BackInStockNotificationRequestCreatedEnvelope, BackInStockNotificationRequestDeletedEnvelope, BackInStockNotificationRequestUpdatedEnvelope, BackInStockNotificationRequestsCount, BaseEventMetadata, CatalogReference, CreateBackInStockNotificationRequestRequest, CreateBackInStockNotificationRequestResponse, CursorPaging, Cursors, DeleteBackInStockNotificationRequestRequest, DeleteBackInStockNotificationRequestResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, File, FocalPoint, GetBackInStockNotificationRequestRequest, GetBackInStockNotificationRequestResponse, GetBackInStockNotificationRequestsCountByCatalogReferencesRequest, GetBackInStockNotificationRequestsCountByCatalogReferencesResponse, IdentificationData, IdentificationDataIdOneOf, InvalidateCache, InvalidateCacheGetByOneOf, MarkAsNotificationSentRequest, MarkAsNotificationSentResponse, MessageEnvelope, Page, PlatformPaging, PlatformPagingMetadata, PlatformQuery, PlatformQueryPagingMethodOneOf, QueryBackInStockNotificationRequestsRequest, QueryBackInStockNotificationRequestsResponse, ReportItemsBackInStockOptions, ReportItemsBackInStockRequest, ReportItemsBackInStockResponse, RequestsQueryBuilder, RequestsQueryResult, RestoreInfo, SortOrder, Sorting, Status, URI, WebhookIdentityType, } from './ecom-v1-back-in-stock-notification-request-back-in-stock-notifications.universal.js';
