...
type BackInStockNotificationRequestNonNullablePaths = `catalogReference.catalogItemId` | `catalogReference.appId` | `email` | `status`;
/**
 ...
 */
export declare function createBackInStockNotificationRequest(request: NonNullablePaths<BackInStockNotificationRequest, `catalogReference` | `catalogReference.appId` | `catalogReference.catalogItemId` | `email`>, itemDetails: NonNullablePaths<BackInStockItemDetails, `name` | `price`>): Promise<NonNullablePaths<BackInStockNotificationRequest, BackInStockNotificationRequestNonNullablePaths>>;
/**
 ...
 */
export declare function getBackInStockNotificationRequest(_id: string): Promise<NonNullablePaths<BackInStockNotificationRequest, BackInStockNotificationRequestNonNullablePaths>>;
/**
 ...
 */
export declare function markAsNotificationSent(_id: string): Promise<NonNullablePaths<MarkAsNotificationSentResponse, {
    [P in BackInStockNotificationRequestNonNullablePaths]: `request.${P}`;
}[BackInStockNotificationRequestNonNullablePaths]>>;
/**
 ...
 */
export declare function reportItemsBackInStock(itemDetails: NonNullablePaths<BackInStockItemDetails, `name` | `price`>, options?: ReportItemsBackInStockOptions): Promise<void>;
