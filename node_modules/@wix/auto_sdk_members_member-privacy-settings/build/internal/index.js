...
__export(index_exports, {
  ...
  getMemberPrivacySettings: () => getMemberPrivacySettings4,
  setMemberPrivacySettings: () => setMemberPrivacySettings4
});
...
async function getMemberPrivacySettings2() {
  ...
  const reqOpts = getMemberPrivacySettings(
    payload
  );
...
async function setMemberPrivacySettings2(memberPrivacySettings) {
  ...
  const reqOpts = setMemberPrivacySettings(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
function getMemberPrivacySettings3(httpClient) {
  return () => getMemberPrivacySettings2(
    // @ts-ignore
    { httpClient }
  );
}
function setMemberPrivacySettings3(httpClient) {
  return (memberPrivacySettings) => setMemberPrivacySettings2(
    memberPrivacySettings,
    // @ts-ignore
    { httpClient }
  );
...
// src/members-v1-member-privacy-settings-member-privacy-settings.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var getMemberPrivacySettings4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getMemberPrivacySettings3);
var setMemberPrivacySettings4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(setMemberPrivacySettings3);
