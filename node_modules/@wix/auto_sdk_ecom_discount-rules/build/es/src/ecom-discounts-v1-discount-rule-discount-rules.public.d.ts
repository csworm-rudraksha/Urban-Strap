...
import { DiscountRule, DiscountRuleCreatedEnvelope, DiscountRuleDeletedEnvelope, DiscountRuleUpdatedEnvelope, DiscountRulesQueryBuilder, UpdateDiscountRule } from './ecom-discounts-v1-discount-rule-discount-rules.universal.js';
...
interface CreateDiscountRuleSignature {
     ...
     */
    (discountRule: DiscountRule): Promise<DiscountRule>;
}
...
interface UpdateDiscountRuleSignature {
     ...
     */
    (_id: string, discountRule: UpdateDiscountRule): Promise<DiscountRule>;
}
