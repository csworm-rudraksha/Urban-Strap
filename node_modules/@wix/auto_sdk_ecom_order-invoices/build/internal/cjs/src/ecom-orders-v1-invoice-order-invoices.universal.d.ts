 ...
 */
export declare function generateInvoice(orderId: string): Promise<NonNullablePaths<GenerateInvoiceResponse, `invoiceId`>>;
/**
 ...
 */
export declare function addInvoiceToOrder(orderId: string, invoiceInfo: NonNullablePaths<Invoice, `_id` | `appId`>): Promise<NonNullablePaths<AddInvoiceToOrderResponse, {
