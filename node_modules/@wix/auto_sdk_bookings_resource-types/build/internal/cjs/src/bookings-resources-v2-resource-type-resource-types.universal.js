...
exports.countResourceTypes = exports.queryResourceTypes = exports.deleteResourceType = exports.updateResourceType = exports.getResourceType = exports.createResourceType = exports.WebhookIdentityType = exports.SortOrder = exports.CreateResourceTypeErrors = exports.RequestedFields = void 0;
...
})(CreateResourceTypeErrors || (exports.CreateResourceTypeErrors = CreateResourceTypeErrors = {}));
var SortOrder;
(function (SortOrder) {
    SortOrder["ASC"] = "ASC";
    SortOrder["DESC"] = "DESC";
...
async function createResourceType(resourceType) {
    ...
    try {
        ...
        return (0, rename_all_nested_keys_1.renameKeysFromRESTResponseToSDKResponse)(result.data)?.resourceType;
    }
    catch (err) {
 ...
 */
function queryResourceTypes(options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
