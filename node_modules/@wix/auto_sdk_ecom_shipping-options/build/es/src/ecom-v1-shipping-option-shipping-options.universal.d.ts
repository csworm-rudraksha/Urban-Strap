...
type ShippingOptionNonNullablePaths = `deliveryRegionId` | `deliveryRegionIds` | `rates` | `rates.${number}.amount` | `rates.${number}.multiplyByQuantity`;
/**
 ...
 */
export declare function createShippingOption(shippingOption: ShippingOption): Promise<NonNullablePaths<ShippingOption, ShippingOptionNonNullablePaths>>;
/**
 ...
 */
export declare function getShippingOption(shippingOptionId: string): Promise<NonNullablePaths<ShippingOption, ShippingOptionNonNullablePaths>>;
/**
 ...
 */
export declare function updateShippingOption(_id: string, shippingOption: NonNullablePaths<UpdateShippingOption, `revision`>): Promise<NonNullablePaths<ShippingOption, ShippingOptionNonNullablePaths>>;
...
export declare function updateExtendedFields(_id: string, namespace: string, options: NonNullablePaths<UpdateExtendedFieldsOptions, `namespaceData`>): Promise<NonNullablePaths<UpdateExtendedFieldsResponse, {
    [P in ShippingOptionNonNullablePaths]: `shippingOption.${P}`;
}[ShippingOptionNonNullablePaths]>>;
