...
export const createCheckoutTemplate = /*#__PURE__*/ createRESTModule(publicCreateCheckoutTemplate);
export const getCheckoutTemplate = /*#__PURE__*/ createRESTModule(publicGetCheckoutTemplate);
export const updateCheckoutTemplate = /*#__PURE__*/ createRESTModule(publicUpdateCheckoutTemplate);
export const deleteCheckoutTemplate = /*#__PURE__*/ createRESTModule(publicDeleteCheckoutTemplate);
export const queryCheckoutTemplates = /*#__PURE__*/ createRESTModule(publicQueryCheckoutTemplates);
export const createCheckoutFromTemplate = /*#__PURE__*/ createRESTModule(publicCreateCheckoutFromTemplate);
export const createAndRedirectToCheckout = /*#__PURE__*/ createRESTModule(publicCreateAndRedirectToCheckout);
/**
 * Triggered when a checkout template is created.
 */
export const onCheckoutTemplateCreated = createEventModule(publicOnCheckoutTemplateCreated);
/**
 * Triggered when a checkout template is deleted.
 */
export const onCheckoutTemplateDeleted = createEventModule(publicOnCheckoutTemplateDeleted);
/**
 * Triggered when a checkout template is updated.
 */
export const onCheckoutTemplateUpdated = createEventModule(publicOnCheckoutTemplateUpdated);
/**
 * Triggered when a checkout is created from a checkout template.
 */
export const onCheckoutTemplateUsed = createEventModule(publicOnCheckoutTemplateUsed);
