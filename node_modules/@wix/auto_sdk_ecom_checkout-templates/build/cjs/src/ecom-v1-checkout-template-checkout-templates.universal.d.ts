 ...
 * @requiredField checkoutTemplate.customLineItems.descriptionLines.value
 ...
 */
export declare function getCheckoutTemplate(checkoutTemplateId: string): Promise<NonNullablePaths<CheckoutTemplate, CheckoutTemplateNonNullablePaths>>;
/**
 ...
 */
export declare function updateCheckoutTemplate(_id: string, checkoutTemplate: UpdateCheckoutTemplate): Promise<NonNullablePaths<CheckoutTemplate, CheckoutTemplateNonNullablePaths>>;
 ...
 */
export declare function createCheckoutFromTemplate(checkoutTemplateId: string, siteId: string): Promise<NonNullablePaths<CreateCheckoutFromTemplateResponse, `checkoutId` | `checkoutUrl`>>;
/**
 ...
 */
export declare function createAndRedirectToCheckout(checkoutTemplateId: string, siteId: string): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`>>;
export {};
