 ...
 */
export async function listBookingFeesByBookingIds(options) {
    // @ts-ignore
 ...
 */
export async function applyBookingFeesToOrder(bookingIds, options) {
    // @ts-ignore
 ...
 */
export async function collectAppliedBookingFees(orderId, options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[2];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        orderId: orderId,
