...
import { Attendance, AttendanceNonNullableFields, AttendancesQueryBuilder, BulkSetAttendanceOptions, BulkSetAttendanceResponse, BulkSetAttendanceResponseNonNullableFields, SetAttendanceOptions, SetAttendanceResponse, SetAttendanceResponseNonNullableFields } from './bookings-v2-attendance-attendance.universal.js';
...
export declare function setAttendance(httpClient: HttpClient): SetAttendanceSignature;
...
export declare function bulkSetAttendance(httpClient: HttpClient): BulkSetAttendanceSignature;
...
export declare function queryAttendance(httpClient: HttpClient): QueryAttendanceSignature;
