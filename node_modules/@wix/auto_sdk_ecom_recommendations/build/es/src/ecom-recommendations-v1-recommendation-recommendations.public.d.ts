...
import { Algorithm, GetRecommendationOptions, GetRecommendationResponse, ListAvailableAlgorithmsResponse } from './ecom-recommendations-v1-recommendation-recommendations.universal.js';
...
interface ListAvailableAlgorithmsSignature {
     ...
     */
    (): Promise<ListAvailableAlgorithmsResponse>;
}
...
interface GetRecommendationSignature {
     ...
     */
    (algorithms: Algorithm[], options?: GetRecommendationOptions | undefined): Promise<GetRecommendationResponse>;
}
export { Algorithm, AlgorithmConfig, AlgorithmInfo, AlgorithmType, CatalogReference, GetRecommendationOptions, GetRecommendationRequest, GetRecommendationResponse, ItemAppIdNotSupportedByProvider, ListAvailableAlgorithmsRequest, ListAvailableAlgorithmsResponse, Recommendation, RecommendationAlgorithmNotSupported, } from './ecom-recommendations-v1-recommendation-recommendations.universal.js';
