...
type RecommendationNonNullablePaths = `items` | `items.${number}.catalogItemId` | `items.${number}.appId` | `algorithm._id` | `algorithm.appId`;
/**
 ...
 */
export declare function listAvailableAlgorithms(): Promise<NonNullablePaths<ListAvailableAlgorithmsResponse, `availableAlgorithms` | `availableAlgorithms.${number}.config.name` | `availableAlgorithms.${number}.config.description` | `availableAlgorithms.${number}.config.algorithmType` | `availableAlgorithms.${number}.config.algorithmId` | `availableAlgorithms.${number}.appId`>>;
/**
 ...
 */
export declare function getRecommendation(algorithms: NonNullablePaths<Algorithm, `_id` | `appId`>[], options?: NonNullablePaths<GetRecommendationOptions, `items.${number}.appId` | `items.${number}.catalogItemId`>): Promise<NonNullablePaths<GetRecommendationResponse, {
    [P in RecommendationNonNullablePaths]: `recommendation.${P}`;
}[RecommendationNonNullablePaths]>>;
