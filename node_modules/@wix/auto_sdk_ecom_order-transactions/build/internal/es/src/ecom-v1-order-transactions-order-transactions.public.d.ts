...
import { AddPaymentsResponse, BulkUpdatePaymentStatusesOptions, BulkUpdatePaymentStatusesResponse, ListTransactionsForMultipleOrdersResponse, ListTransactionsForSingleOrderResponse, Payment, PaymentAndOrderId, UpdatePaymentStatusIdentifiers, UpdatePaymentStatusOptions, UpdatePaymentStatusResponse } from './ecom-v1-order-transactions-order-transactions.universal.js';
...
interface UpdatePaymentStatusSignature {
     ...
     */
    (identifiers: UpdatePaymentStatusIdentifiers, options?: UpdatePaymentStatusOptions | undefined): Promise<UpdatePaymentStatusResponse>;
}
...
interface BulkUpdatePaymentStatusesSignature {
     ...
     */
    (paymentAndOrderIds: PaymentAndOrderId[], options?: BulkUpdatePaymentStatusesOptions | undefined): Promise<BulkUpdatePaymentStatusesResponse>;
}
/** @internal */
export declare function updateRefundTransaction(httpClient: HttpClient): UpdateRefundTransactionSignature;
...
/** @internal */
export declare function updatePayments(httpClient: HttpClient): UpdatePaymentsSignature;
