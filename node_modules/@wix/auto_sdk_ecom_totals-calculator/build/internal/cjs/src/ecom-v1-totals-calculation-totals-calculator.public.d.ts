...
import { CalculateTotalsOptions, CalculateTotalsResponse } from './ecom-v1-totals-calculation-totals-calculator.universal.js';
...
interface CalculateTotalsSignature {
     ...
     */
    (options?: CalculateTotalsOptions | undefined): Promise<CalculateTotalsResponse>;
}
