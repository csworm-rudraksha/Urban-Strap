 ...
 */
export declare function startCollectingRequests(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function stopCollectingRequests(payload: object): RequestOptionsFactory<any>;
/** Retrieves back in stock notification request settings. */
export declare function getSettings(payload: object): RequestOptionsFactory<any>;
