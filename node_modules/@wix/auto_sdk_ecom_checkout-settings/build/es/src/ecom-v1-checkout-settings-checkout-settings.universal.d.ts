...
type CheckoutSettingsNonNullablePaths = `checkoutBrand.header.logo.size` | `checkoutBrand.header.alignment`;
/**
 ...
 */
export declare function getCheckoutSettings(): Promise<NonNullablePaths<GetCheckoutSettingsResponse, {
    [P in CheckoutSettingsNonNullablePaths]: `checkoutSettings.${P}`;
}[CheckoutSettingsNonNullablePaths]>>;
/**
 ...
 */
export declare function updateCheckoutSettings(checkoutSettings: CheckoutSettings): Promise<NonNullablePaths<UpdateCheckoutSettingsResponse, {
    [P in CheckoutSettingsNonNullablePaths]: `checkoutSettings.${P}`;
}[CheckoutSettingsNonNullablePaths]>>;
export {};
