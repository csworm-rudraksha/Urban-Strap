...
export interface AbandonedCartNonNullableFields {
    _id: string;
    status: Status;
 ...
 */
export declare function onAbandonedCartCartAbandonedEvent(handler: (event: AbandonedCartCartAbandonedEnvelope) => void | Promise<void>): void;
 ...
 * @targetRemovalDate 2024-03-31
 */
export declare function onAbandonedCartCartRecoveredEvent(handler: (event: AbandonedCartCartRecoveredEnvelope) => void | Promise<void>): void;
/**
 ...
 * @targetRemovalDate 2024-03-31
 */
export declare function getAbandonedCart(_id: string): Promise<AbandonedCart & AbandonedCartNonNullableFields>;
/**
 ...
 * @targetRemovalDate 2024-03-31
 */
export declare function queryAbandonedCarts(options?: QueryAbandonedCartsOptions): Promise<QueryAbandonedCartsResponse & QueryAbandonedCartsResponseNonNullableFields>;
