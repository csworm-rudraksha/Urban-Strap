 ...
 */
export declare function recordManuallyCollectedPayment(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function paymentCollectionMarkOrderAsPaid(payload: object): RequestOptionsFactory<any>;
/** Marks multiple orders as paid. `order.paymentStatus` field *eventually* changes to `PAID`. */
export declare function paymentCollectionBulkMarkOrdersAsPaid(payload: object): RequestOptionsFactory<any>;
/** Checks whether this order can be refunded. */
export declare function getRefundabilityStatus(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function paymentCollectionCreatePaymentGatewayOrder(payload: object): RequestOptionsFactory<any>;
export declare function chargeMemberships(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function triggerRefund(payload: object): RequestOptionsFactory<any>;
/**
...
export declare function commitDeltas(payload: object): RequestOptionsFactory<any>;
/** @deprecated Will be removed on 2024-02-15. */
export declare function updateOrderLineItem(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function addActivity(payload: object): RequestOptionsFactory<any>;
/** Updates an order's activity. */
export declare function updateActivity(payload: object): RequestOptionsFactory<any>;
/**
 * Delete's an order's activity.
 *
 * Only custom activities and merchant comments can be deleted.
 */
export declare function deleteActivity(payload: object): RequestOptionsFactory<any>;
/**
 * Cancels an order.
 *
 *
 ...
 */
export declare function updateOrderStatus(payload: object): RequestOptionsFactory<any>;
export declare function aggregateOrders(payload: object): RequestOptionsFactory<any>;
/**
