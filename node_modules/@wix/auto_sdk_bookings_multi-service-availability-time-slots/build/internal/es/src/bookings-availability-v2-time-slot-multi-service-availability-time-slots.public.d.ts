...
import { GetMultiServiceAvailabilityTimeSlotResponse, GetMultiServiceAvailabilityTimeSlotResponseNonNullableFields, ListMultiServiceAvailabilityTimeSlotsOptions, ListMultiServiceAvailabilityTimeSlotsResponse, ListMultiServiceAvailabilityTimeSlotsResponseNonNullableFields, Location, Service } from './bookings-availability-v2-time-slot-multi-service-availability-time-slots.universal.js';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function listMultiServiceAvailabilityTimeSlots(httpClient: HttpClient): ListMultiServiceAvailabilityTimeSlotsSignature;
interface ListMultiServiceAvailabilityTimeSlotsSignature {
     ...
     */
    (options?: ListMultiServiceAvailabilityTimeSlotsOptions | undefined): Promise<ListMultiServiceAvailabilityTimeSlotsResponse & ListMultiServiceAvailabilityTimeSlotsResponseNonNullableFields>;
}
