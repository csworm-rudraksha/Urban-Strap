 ...
 */
export declare function updateCart(_id: string, options?: NonNullablePaths<UpdateCartOptions, `customLineItems.${number}.descriptionLines` | `customLineItems.${number}.descriptionLines.${number}.name` | `customLineItems.${number}.itemType` | `customLineItems.${number}.productName` | `lineItems.${number}.catalogReference`>): Promise<NonNullablePaths<Cart, CartNonNullablePaths>>;
 ...
 */
export declare function getCart(_id: string): Promise<NonNullablePaths<Cart, CartNonNullablePaths>>;
/**
 ...
 */
export declare function getCartByCheckoutId(_id: string): Promise<NonNullablePaths<GetCartByCheckoutIdResponse, {
 ...
 */
export declare function addToCart(_id: string, options?: NonNullablePaths<AddToCartOptions, `customLineItems.${number}.descriptionLines` | `customLineItems.${number}.descriptionLines.${number}.name` | `customLineItems.${number}.itemType` | `customLineItems.${number}.price` | `customLineItems.${number}.productName` | `customLineItems.${number}.quantity` | `lineItems.${number}.catalogReference` | `lineItems.${number}.selectedMembership._id` | `lineItems.${number}.selectedMembership.appId`>): Promise<NonNullablePaths<AddToCartResponse, {
    [P in CartNonNullablePaths]: `cart.${P}`;
}[CartNonNullablePaths]>>;
 ...
 */
export declare function createCheckout(_id: string, options?: CreateCheckoutOptions): Promise<NonNullablePaths<CreateCheckoutResponse, `checkoutId`>>;
 ...
 */
export declare function updateLineItemsQuantity(_id: string, lineItems: LineItemQuantityUpdate[]): Promise<NonNullablePaths<UpdateLineItemsQuantityResponse, {
    [P in CartNonNullablePaths]: `cart.${P}`;
}[CartNonNullablePaths]>>;
/**
 ...
 */
export declare function estimateTotals(_id: string, options?: EstimateTotalsOptions): Promise<NonNullablePaths<EstimateTotalsResponse, {
    [P in CartNonNullablePaths]: `cart.${P}`;
 ...
 */
export declare function removeBusinessLocation(_id: string): Promise<NonNullablePaths<RemoveBusinessLocationResponse, {
    [P in CartNonNullablePaths]: `cart.${P}`;
}[CartNonNullablePaths]>>;
export {};
