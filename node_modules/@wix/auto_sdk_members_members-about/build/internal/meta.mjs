...
// src/members-about-v2-member-about-members-about.meta.ts
function createMemberAbout2() {
  const payload = {};
  const getRequestOptions = createMemberAbout(payload);
...
function updateMemberAbout2() {
  const payload = { memberAbout: { id: ":memberAboutId" } };
  const getRequestOptions = updateMemberAbout(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "PATCH",
    path: "/v2/abouts/{memberAbout.id}",
    pathParams: { memberAboutId: "memberAboutId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
    __originalResponseType: null
...
function deleteMemberAbout2() {
  const payload = { id: ":id" };
  const getRequestOptions = deleteMemberAbout(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getMemberAbout2() {
  const payload = { id: ":id" };
  const getRequestOptions = getMemberAbout(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getMyMemberAbout2() {
  const payload = {};
  const getRequestOptions = getMyMemberAbout(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryMemberAbouts2() {
  const payload = {};
  const getRequestOptions = queryMemberAbouts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
