...
import { GetAvailabilityTimeSlotOptions, GetAvailabilityTimeSlotResponse, GetAvailabilityTimeSlotResponseNonNullableFields, ListAvailabilityTimeSlotsOptions, ListAvailabilityTimeSlotsResponse, ListAvailabilityTimeSlotsResponseNonNullableFields, Location } from './bookings-availability-v2-time-slot-availability-time-slots.universal.js';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function listAvailabilityTimeSlots(httpClient: HttpClient): ListAvailabilityTimeSlotsSignature;
interface ListAvailabilityTimeSlotsSignature {
     ...
     */
    (options?: ListAvailabilityTimeSlotsOptions | undefined): Promise<ListAvailabilityTimeSlotsResponse & ListAvailabilityTimeSlotsResponseNonNullableFields>;
}
export declare function getAvailabilityTimeSlot(httpClient: HttpClient): GetAvailabilityTimeSlotSignature;
