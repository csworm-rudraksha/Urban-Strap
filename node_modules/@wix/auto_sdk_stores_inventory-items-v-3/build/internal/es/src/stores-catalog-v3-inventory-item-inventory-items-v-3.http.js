...
export function bulkCreateInventoryItems(payload) {
...
export function getInventoryItem(payload) {
 ...
 * This ensures you're working with the latest inventory item and prevents unintended overwrites.
 */
export function bulkUpdateInventoryItems(payload) {
 ...
 * This ensures you're working with the latest inventory item and prevents unintended overwrites.
 */
export function bulkUpdateInventoryItemsByFilter(payload) {
...
export function bulkDeleteInventoryItems(payload) {
 ...
 */
export function queryInventoryItems(payload) {
 ...
 * and [Sorting and Paging](https://dev.wix.com/docs/rest/articles/getting-started/sorting-and-paging).
 */
export function searchInventoryItems(payload) {
 ...
 */
export function bulkDecrementInventoryItems(payload) {
 ...
 */
export function bulkIncrementInventoryItems(payload) {
 ...
 * > + If you pass `preorderRequest: true` and the item is available for preorder, the item's `preorderCounter` will increase and the item's quantity will stay the same.
 */
export function bulkDecrementInventoryItemsByVariantAndLocation(payload) {
 ...
 * > **Note:** `trackQuantity` must be `true` to allow for incrementing the quantity.
 */
export function bulkIncrementInventoryItemsByVariantAndLocation(payload) {
 ...
 */
export function bulkSetOrAdjustInventoryItemsByFilter(payload) {
