...
export interface InventoryItemNonNullableFields {
    inStock: boolean;
    quantity: number;
    variantId: string;
    productId: string;
 ...
 */
export declare function onInventoryItemCreated(handler: (event: InventoryItemCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onInventoryItemDeleted(handler: (event: InventoryItemDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onInventoryItemStockStatusUpdated(handler: (event: InventoryItemStockStatusUpdatedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onInventoryItemUpdated(handler: (event: InventoryItemUpdatedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
export declare function onInventoryItemUpdatedWithReason(handler: (event: InventoryItemUpdatedWithReasonEnvelope) => void | Promise<void>): void;
/**
 ...
 */
export declare function createInventoryItem(inventoryItem: InventoryItem): Promise<InventoryItem & InventoryItemNonNullableFields>;
/**
 ...
 */
export declare function bulkCreateInventoryItems(inventoryItems: InventoryItem[], options?: BulkCreateInventoryItemsOptions): Promise<BulkCreateInventoryItemsResponse & BulkCreateInventoryItemsResponseNonNullableFields>;
 ...
 */
export declare function getInventoryItem(inventoryItemId: string): Promise<InventoryItem & InventoryItemNonNullableFields>;
/**
 ...
 */
export declare function updateInventoryItem(_id: string | null, inventoryItem: UpdateInventoryItem, options?: UpdateInventoryItemOptions): Promise<InventoryItem & InventoryItemNonNullableFields>;
 ...
 */
export declare function bulkUpdateInventoryItems(inventoryItems: MaskedInventoryItem[], options?: BulkUpdateInventoryItemsOptions): Promise<BulkUpdateInventoryItemsResponse & BulkUpdateInventoryItemsResponseNonNullableFields>;
 ...
 */
export declare function bulkUpdateInventoryItemsByFilter(filter: Record<string, any> | null, options?: BulkUpdateInventoryItemsByFilterOptions): Promise<BulkUpdateInventoryItemsByFilterResponse & BulkUpdateInventoryItemsByFilterResponseNonNullableFields>;
 ...
 */
export declare function deleteInventoryItem(inventoryItemId: string): Promise<void>;
/**
 ...
 */
export declare function bulkDeleteInventoryItems(inventoryItemIds: string[]): Promise<BulkDeleteInventoryItemsResponse & BulkDeleteInventoryItemsResponseNonNullableFields>;
/**
 ...
 */
export declare function queryInventoryItems(): InventoryItemsQueryBuilder;
 ...
 */
export declare function searchInventoryItems(options?: SearchInventoryItemsOptions): Promise<SearchInventoryItemsResponse & SearchInventoryItemsResponseNonNullableFields>;
export interface SearchInventoryItemsOptions {
    /** Search options. */
    search?: CursorSearch;
}
/**
 ...
 */
export declare function bulkDecrementInventoryItems(decrementData: DecrementDataById[], options?: BulkDecrementInventoryItemsOptions): Promise<BulkDecrementInventoryItemsResponse & BulkDecrementInventoryItemsResponseNonNullableFields>;
 ...
 */
export declare function bulkIncrementInventoryItems(incrementData: IncrementDataById[], options?: BulkIncrementInventoryItemsOptions): Promise<BulkIncrementInventoryItemsResponse & BulkIncrementInventoryItemsResponseNonNullableFields>;
 ...
 */
export declare function bulkIncrementInventoryItemsByVariantAndLocation(incrementData: IncrementDataByVariantAndLocation[], options?: BulkIncrementInventoryItemsByVariantAndLocationOptions): Promise<BulkIncrementInventoryItemsByVariantAndLocationResponse & BulkIncrementInventoryItemsByVariantAndLocationResponseNonNullableFields>;
 ...
 * @requiredField options.adjustedInventoryAction.action
 * @permissionId WIX_STORES.INVENTORY_UPDATE
 * @permissionScope Manage Stores - all permissions
 * @permissionScopeId SCOPE.DC-STORES-MEGA.MANAGE-STORES
 * @permissionScope Inventory write in v3 catalog
 ...
 */
export declare function bulkSetOrAdjustInventoryItemsByFilter(filter: Record<string, any> | null, options?: BulkSetOrAdjustInventoryItemsByFilterOptions): Promise<BulkSetOrAdjustInventoryItemsByFilterResponse & BulkSetOrAdjustInventoryItemsByFilterResponseNonNullableFields>;
