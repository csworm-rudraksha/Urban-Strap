...
// src/members-v1-default-privacy-default-privacy.meta.ts
function getDefaultPrivacyStatus2() {
  const payload = {};
  const getRequestOptions = getDefaultPrivacyStatus(payload);
...
function setDefaultPrivacyStatus2() {
  const payload = {};
  const getRequestOptions = setDefaultPrivacyStatus(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
export {
  getDefaultPrivacyStatus2 as getDefaultPrivacyStatus,
  setDefaultPrivacyStatus2 as setDefaultPrivacyStatus
};
