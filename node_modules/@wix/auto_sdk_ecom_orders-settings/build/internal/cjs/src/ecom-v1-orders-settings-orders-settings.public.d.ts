...
import { GetOrdersSettingsResponse, OrdersSettings, OrdersSettingsUpdatedEnvelope, UpdateOrdersSettingsResponse } from './ecom-v1-orders-settings-orders-settings.universal.js';
...
interface GetOrdersSettingsSignature {
     ...
     */
    (): Promise<GetOrdersSettingsResponse>;
}
...
interface UpdateOrdersSettingsSignature {
     ...
     */
    (ordersSettings: OrdersSettings): Promise<UpdateOrdersSettingsResponse>;
}
...
export { ActionEvent, BaseEventMetadata, DeleteOrdersSettingsRequest, DeleteOrdersSettingsResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, GetOrdersSettingsRequest, GetOrdersSettingsResponse, IdentificationData, IdentificationDataIdOneOf, InventoryUpdateTrigger, ListOrdersSettingsRequest, ListOrdersSettingsResponse, MessageEnvelope, OrdersSettings, OrdersSettingsUpdatedEnvelope, RestoreInfo, UpdateOrdersSettingsRequest, UpdateOrdersSettingsResponse, WebhookIdentityType, } from './ecom-v1-orders-settings-orders-settings.universal.js';
