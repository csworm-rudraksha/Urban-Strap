...
import { ConversionRateResponse, ConvertCurrencyIdentifiers, ConvertCurrencyResponse, DecimalValue, GetConversionRateIdentifiers, ListCurrenciesResponse } from './ecommerce-currency-converter-v1-currency-rate-currencies.universal.js';
...
interface ConvertCurrencySignature {
     ...
     */
    (identifiers: ConvertCurrencyIdentifiers, amounts: DecimalValue[]): Promise<ConvertCurrencyResponse>;
}
...
interface GetConversionRateSignature {
     ...
     */
    (identifiers: GetConversionRateIdentifiers): Promise<ConversionRateResponse>;
}
export { ConversionRateRequest, ConversionRateResponse, ConvertCurrencyIdentifiers, ConvertCurrencyRequest, ConvertCurrencyResponse, Currency, CurrencyRate, DecimalValue, GetConversionRateIdentifiers, ListCurrenciesRequest, ListCurrenciesResponse, } from './ecommerce-currency-converter-v1-currency-rate-currencies.universal.js';
