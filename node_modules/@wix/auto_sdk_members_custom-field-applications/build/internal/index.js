...
__export(index_exports, {
  AppliesToAppliesTo: () => AppliesToAppliesTo,
  ExclusionType: () => ExclusionType,
  FieldTypeType: () => FieldTypeType,
  Origin: () => Origin,
  Privacy: () => Privacy,
  Section: () => Section,
  SocialTypeType: () => SocialTypeType,
  Type: () => Type,
  WebhookIdentityType: () => WebhookIdentityType,
  createCustomFieldApplication: () => createCustomFieldApplication4,
  deleteCustomFieldApplication: () => deleteCustomFieldApplication4,
  getCustomFieldApplication: () => getCustomFieldApplication4,
  getCustomFieldApplications: () => getCustomFieldApplications4,
  getMembersCustomFieldApplications: () => getMembersCustomFieldApplications4,
  getRolesCustomFieldApplications: () => getRolesCustomFieldApplications4,
  updateCustomFieldApplication: () => updateCustomFieldApplication4
});
...
var AppliesToAppliesTo = /* @__PURE__ */ ((AppliesToAppliesTo2) => {
  AppliesToAppliesTo2["ALL_MEMBERS"] = "ALL_MEMBERS";
  AppliesToAppliesTo2["SELECTED_MEMBERS"] = "SELECTED_MEMBERS";
  return AppliesToAppliesTo2;
})(AppliesToAppliesTo || {});
...
async function createCustomFieldApplication2(application) {
  ...
  const reqOpts = createCustomFieldApplication(
    payload
  );
  ...
  try {
    ...
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(result.data)?.application;
  } catch (err) {
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { application: "$[0]" },
...
async function deleteCustomFieldApplication2(customFieldId) {
  ...
  const reqOpts = deleteCustomFieldApplication(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { customFieldId: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["customFieldId"]
    );
...
async function updateCustomFieldApplication2(customFieldId, application) {
  ...
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    application: { ...application, customFieldId }
  });
  const reqOpts = updateCustomFieldApplication(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        spreadPathsToArguments: { application: "$[1]" },
        explicitPathsToArguments: { "application.customFieldId": "$[0]" },
        singleArgumentUnchanged: false
      },
      ["customFieldId", "application"]
    );
    sideEffects?.onError?.(err);
    throw transformedError;
  }
...
async function getCustomFieldApplication2(customFieldId) {
  ...
  const reqOpts = getCustomFieldApplication(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function getCustomFieldApplications2(customFieldIds) {
  ...
  const reqOpts = getCustomFieldApplications(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { customFieldIds: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["customFieldIds"]
    );
...
async function getMembersCustomFieldApplications2(memberIds) {
  ...
  const reqOpts = getMembersCustomFieldApplications(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function getRolesCustomFieldApplications2(roleIds) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({ roleIds });
  const reqOpts = getRolesCustomFieldApplications(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: { roleIds: "$[0]" },
        singleArgumentUnchanged: false
      },
      ["roleIds"]
    );
...
function createCustomFieldApplication3(httpClient) {
  return (application) => createCustomFieldApplication2(
    application,
    // @ts-ignore
    { httpClient }
  );
...
function deleteCustomFieldApplication3(httpClient) {
  return (customFieldId) => deleteCustomFieldApplication2(
    customFieldId,
    // @ts-ignore
    { httpClient }
  );
...
function updateCustomFieldApplication3(httpClient) {
  return (customFieldId, application) => updateCustomFieldApplication2(
    customFieldId,
    application,
    // @ts-ignore
    { httpClient }
...
function getCustomFieldApplication3(httpClient) {
  return (customFieldId) => getCustomFieldApplication2(
    customFieldId,
    // @ts-ignore
    { httpClient }
  );
...
function getCustomFieldApplications3(httpClient) {
  return (customFieldIds) => getCustomFieldApplications2(
    customFieldIds,
    // @ts-ignore
    { httpClient }
  );
...
function getMembersCustomFieldApplications3(httpClient) {
  return (memberIds) => getMembersCustomFieldApplications2(
    memberIds,
    // @ts-ignore
    { httpClient }
  );
...
function getRolesCustomFieldApplications3(httpClient) {
  return (roleIds) => getRolesCustomFieldApplications2(
    roleIds,
    // @ts-ignore
    { httpClient }
  );
...
// src/members-v1-custom-field-application-custom-field-applications.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var createCustomFieldApplication4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(createCustomFieldApplication3);
var deleteCustomFieldApplication4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(deleteCustomFieldApplication3);
var updateCustomFieldApplication4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updateCustomFieldApplication3);
var getCustomFieldApplication4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getCustomFieldApplication3);
var getCustomFieldApplications4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getCustomFieldApplications3);
var getMembersCustomFieldApplications4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getMembersCustomFieldApplications3);
var getRolesCustomFieldApplications4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getRolesCustomFieldApplications3);
