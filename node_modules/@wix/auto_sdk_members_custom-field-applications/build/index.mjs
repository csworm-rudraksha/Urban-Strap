...
async function createCustomFieldApplication2(application) {
  ...
  try {
    ...
    return renameKeysFromRESTResponseToSDKResponse(result.data)?.application;
  } catch (err) {
...
async function getRolesCustomFieldApplications2(roleIds) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({ roleIds });
...
var createCustomFieldApplication4 = /* @__PURE__ */ createRESTModule(createCustomFieldApplication3);
var deleteCustomFieldApplication4 = /* @__PURE__ */ createRESTModule(deleteCustomFieldApplication3);
var updateCustomFieldApplication4 = /* @__PURE__ */ createRESTModule(updateCustomFieldApplication3);
var getCustomFieldApplication4 = /* @__PURE__ */ createRESTModule(getCustomFieldApplication3);
var getCustomFieldApplications4 = /* @__PURE__ */ createRESTModule(getCustomFieldApplications3);
var getMembersCustomFieldApplications4 = /* @__PURE__ */ createRESTModule(getMembersCustomFieldApplications3);
var getRolesCustomFieldApplications4 = /* @__PURE__ */ createRESTModule(getRolesCustomFieldApplications3);
export {
  AppliesToAppliesTo,
  ExclusionType,
  FieldTypeType,
  ...
  Type,
  WebhookIdentityType,
  createCustomFieldApplication4 as createCustomFieldApplication,
  deleteCustomFieldApplication4 as deleteCustomFieldApplication,
  getCustomFieldApplication4 as getCustomFieldApplication,
  getCustomFieldApplications4 as getCustomFieldApplications,
  getMembersCustomFieldApplications4 as getMembersCustomFieldApplications,
  getRolesCustomFieldApplications4 as getRolesCustomFieldApplications,
  updateCustomFieldApplication4 as updateCustomFieldApplication
};
