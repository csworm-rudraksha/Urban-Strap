 ...
 */
export declare function generateReceipts(orderId: string, options: NonNullablePaths<GenerateReceiptsOptions, `paymentIds`>): Promise<NonNullablePaths<GenerateReceiptsResponse, `receipts` | `receipts.${number}.paymentId` | `receipts.${number}.receiptId`>>;
