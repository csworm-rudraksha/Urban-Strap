...
__export(index_exports, {
  ...
  SortOrder: () => SortOrder,
  Type: () => Type,
  listCustomFieldSuggestions: () => listCustomFieldSuggestions4,
  queryCustomFieldSuggestions: () => queryCustomFieldSuggestions4
});
...
async function listCustomFieldSuggestions2(options) {
  ...
  const reqOpts = listCustomFieldSuggestions(
    payload
  );
...
function queryCustomFieldSuggestions2() {
  ...
  return (0, import_query_builder.queryBuilder)({
    func: async (payload) => {
      const reqOpts = queryCustomFieldSuggestions(
        payload
      );
      sideEffects?.onSiteCall?.();
      try {
...
function listCustomFieldSuggestions3(httpClient) {
  return (options) => listCustomFieldSuggestions2(
    options,
    // @ts-ignore
    { httpClient }
  );
...
function queryCustomFieldSuggestions3(httpClient) {
  return () => queryCustomFieldSuggestions2(
    // @ts-ignore
    { httpClient }
  );
}

// src/members-v1-custom-field-suggestion-custom-field-suggestions.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var listCustomFieldSuggestions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listCustomFieldSuggestions3);
var queryCustomFieldSuggestions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(queryCustomFieldSuggestions3);
