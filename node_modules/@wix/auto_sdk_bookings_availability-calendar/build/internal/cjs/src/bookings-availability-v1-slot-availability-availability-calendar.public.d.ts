...
import { CalculateMultiSlotAvailabilityOptions, CalculateMultiSlotAvailabilityResponse, CalculateMultiSlotAvailabilityResponseNonNullableFields, GetScheduleAvailabilityResponse, QueryAvailabilityOptions, QueryAvailabilityResponse, QueryAvailabilityResponseNonNullableFields, QueryV2 } from './bookings-availability-v1-slot-availability-availability-calendar.universal.js';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function queryAvailability(httpClient: HttpClient): QueryAvailabilitySignature;
interface QueryAvailabilitySignature {
     ...
     */
    (query: QueryV2, options?: QueryAvailabilityOptions | undefined): Promise<QueryAvailabilityResponse & QueryAvailabilityResponseNonNullableFields>;
}
export declare function getScheduleAvailability(httpClient: HttpClient): GetScheduleAvailabilitySignature;
...
export declare function calculateMultiSlotAvailability(httpClient: HttpClient): CalculateMultiSlotAvailabilitySignature;
interface CalculateMultiSlotAvailabilitySignature {
    /** */
    (options?: CalculateMultiSlotAvailabilityOptions | undefined): Promise<CalculateMultiSlotAvailabilityResponse & CalculateMultiSlotAvailabilityResponseNonNullableFields>;
}
export { AvailabilityWaitingList, AvailableResources, BookingPolicySettings, BookingPolicyViolations, CalculateMultiSlotAvailabilityOptions, CalculateMultiSlotAvailabilityRequest, CalculateMultiSlotAvailabilityResponse, CalculateMultiSlotAvailabilityResponseNonNullableFields, CursorPaging, CursorPagingMetadata, Cursors, CustomerChoices, EventInfo, GetAvailabilityTimeSlotRequest, GetAvailabilityTimeSlotResponse, GetScheduleAvailabilityRequest, GetScheduleAvailabilityResponse, GetSlotAvailabilityRequest, GetSlotAvailabilityResponse, Location, LocationLocationType, LocationType, NestedTimeSlot, PagingMetadataV2, QueryAvailabilityOptions, QueryAvailabilityRequest, QueryAvailabilityResponse, QueryAvailabilityResponseNonNullableFields, QueryV2, QueryV2PagingMethodOneOf, Resource, ResourcesFilter, RuleBasedConstraints, ScheduleAvailability, Service_availabilityBookingPolicyViolations, Service_availabilityNestedTimeSlot, Slot, SlotAvailability, SlotResource, SortOrder, Sorting, TimeSlot, TimeSlotLocation, V2CustomerChoices, WaitingList, } from './bookings-availability-v1-slot-availability-availability-calendar.universal.js';
