...
type StaffNonNullablePaths = `identificationData.anonymousVisitorId` | `identificationData.memberId` | `identificationData.wixUserId` | `identificationData.appId`;
/**
 ...
 */
export declare function listTippableStaff(options?: ListTippableStaffOptions): Promise<NonNullablePaths<ListTippableStaffResponse, {
    [P in StaffNonNullablePaths]: `staff.${number}.${P}`;
}[StaffNonNullablePaths]>>;
