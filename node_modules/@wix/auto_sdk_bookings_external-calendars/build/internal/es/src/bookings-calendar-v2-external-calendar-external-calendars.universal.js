 ...
 */
export async function connectByOAuth(providerId, scheduleId, redirectUrl) {
    // @ts-ignore
 ...
 */
export async function connectByCredentials(providerId, scheduleId, email, password) {
    // @ts-ignore
 ...
 */
export async function listCalendars(connectionId) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = renameKeysFromSDKRequestToRESTRequest({
        connectionId: connectionId,
 ...
 */
export async function updateSyncConfig(connectionId, syncConfig) {
    // @ts-ignore
