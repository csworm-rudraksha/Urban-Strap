 ...
 */
export declare function listProviders(): Promise<ListProvidersResponse & ListProvidersResponseNonNullableFields>;
/**
 ...
 */
export declare function getConnection(connectionId: string | null): Promise<GetConnectionResponse & GetConnectionResponseNonNullableFields>;
/**
 ...
 */
export declare function listConnections(options?: ListConnectionsOptions): Promise<ListConnectionsResponse & ListConnectionsResponseNonNullableFields>;
 ...
 */
export declare function connectByOAuth(providerId: string | null, scheduleId: string | null, redirectUrl: string | null): Promise<ConnectByOAuthResponse>;
/**
 * Connects a *Wix schedule*
 * ([SDK](https://dev.wix.com/docs/sdk/backend-modules/calendar/schedules/introduction) | [REST](https://dev.wix.com/docs/rest/business-management/calendar/schedules-v3/introduction))
 ...
 */
export declare function connectByCredentials(providerId: string | null, scheduleId: string | null, email: string | null, password: string | null): Promise<ConnectByCredentialsResponse & ConnectByCredentialsResponseNonNullableFields>;
/**
 ...
 */
export declare function listCalendars(connectionId: string | null): Promise<ListCalendarsResponse>;
/**
 ...
 */
export declare function updateSyncConfig(connectionId: string | null, syncConfig: ConnectionSyncConfig): Promise<UpdateSyncConfigResponse & UpdateSyncConfigResponseNonNullableFields>;
/**
 ...
 */
export declare function disconnect(connectionId: string | null): Promise<DisconnectResponse & DisconnectResponseNonNullableFields>;
/**
