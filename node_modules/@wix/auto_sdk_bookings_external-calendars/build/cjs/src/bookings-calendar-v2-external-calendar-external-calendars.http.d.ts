 ...
 */
export declare function listProviders(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function getConnection(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function listConnections(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function connectByOAuth(payload: object): RequestOptionsFactory<any>;
/**
 * Connects a *Wix schedule*
 * ([SDK](https://dev.wix.com/docs/sdk/backend-modules/calendar/schedules/introduction) | [REST](https://dev.wix.com/docs/rest/business-management/calendar/schedules-v3/introduction))
 ...
 * including which authorization methods they support.
 */
export declare function connectByCredentials(payload: object): RequestOptionsFactory<any>;
/** Retrieves details about the external calendar accounts associated with the specified connection. */
export declare function listCalendars(payload: object): RequestOptionsFactory<any>;
/**
 ...
 * ([SDK](https://dev.wix.com/docs/sdk/backend-modules/bookings/external-calendars/list-connections) | [REST](https://dev.wix.com/docs/rest/business-solutions/bookings/calendar/external-calendar-v2/list-connections)).
 */
export declare function updateSyncConfig(payload: object): RequestOptionsFactory<any>;
/**
 ...
 */
export declare function disconnect(payload: object): RequestOptionsFactory<any>;
/**
