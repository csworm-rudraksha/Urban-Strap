...
import { BulkCreateFulfillmentResponse, BulkCreateOrderWithFulfillments, CreateFulfillmentResponse, DeleteFulfillmentIdentifiers, DeleteFulfillmentResponse, Fulfillment, FulfillmentsUpdatedEnvelope, ListFulfillmentsForMultipleOrdersResponse, ListFulfillmentsForSingleOrderResponse, OrderWithFulfillments, UpdateFulfillmentIdentifiers, UpdateFulfillmentOptions } from './ecom-v1-fulfillments-order-fulfillments.universal.js';
...
interface DeleteFulfillmentSignature {
     ...
     */
    (identifiers: DeleteFulfillmentIdentifiers): Promise<DeleteFulfillmentResponse>;
}
...
interface BulkCreateFulfillmentsSignature {
     ...
     */
    (ordersWithFulfillments: BulkCreateOrderWithFulfillments[]): Promise<BulkCreateFulfillmentResponse>;
}
export declare const onFulfillmentsUpdated: EventDefinition<FulfillmentsUpdatedEnvelope, "wix.ecom.v1.fulfillments_updated">;
export { ActionEvent, ApplicationError, BaseEventMetadata, BulkActionMetadata, BulkCreateFulfillmentRequest, BulkCreateFulfillmentResponse, BulkCreateOrderWithFulfillments, BulkOrderFulfillmentsResult, BuyerInfo, CreateFulfillmentRequest, CreateFulfillmentResponse, CustomFulfillmentInfo, DeleteFulfillmentIdentifiers, DeleteFulfillmentRequest, DeleteFulfillmentResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, Fulfillment, FulfillmentCreated, FulfillmentDeleted, FulfillmentFulfillmentInfoOneOf, FulfillmentLineItem, FulfillmentStatus, FulfillmentTrackingInfo, FulfillmentUpdated, FulfillmentsUpdatedEnvelope, IdentificationData, IdentificationDataIdOneOf, IdentityType, ItemMetadata, ListFulfillmentsForMultipleOrdersRequest, ListFulfillmentsForMultipleOrdersResponse, ListFulfillmentsForSingleOrderRequest, ListFulfillmentsForSingleOrderResponse, MessageEnvelope, OrderWithFulfillments, RestoreInfo, UpdateFulfillmentIdentifiers, UpdateFulfillmentOptions, UpdateFulfillmentRequest, UpdateFulfillmentResponse, V2FulfillmentTrackingInfo, WebhookIdentityType, } from './ecom-v1-fulfillments-order-fulfillments.universal.js';
