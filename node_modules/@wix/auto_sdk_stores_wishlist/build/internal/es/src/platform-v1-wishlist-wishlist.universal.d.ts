...
export interface WishlistDataNonNullableFields {
    ownerId: string;
 ...
 */
export declare function getWishlistById(_id: string, options?: GetWishlistByIdOptions): Promise<WishlistData & WishlistDataNonNullableFields>;
