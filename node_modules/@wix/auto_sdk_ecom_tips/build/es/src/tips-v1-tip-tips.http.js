...
const PACKAGE_NAME = '@wix/auto_sdk_ecom_tips';
/**
 ...
 */
export function previewTip(payload) {
 ...
 */
export function getTipByOrderId(payload) {
 ...
 * </blockquote>
 */
export function getTipByDraftOrderId(payload) {
 ...
 */
export function getTipChoice(payload) {
 ...
 * Please refer to the Sample Flows for more information.
 */
export function updateTipChoice(payload) {
 ...
 */
export function setTipOnOrder(payload) {
 ...
 */
export function removeTipFromOrder(payload) {
 ...
 */
export function addTipDistributionsToOrder(payload) {
 ...
 *
 */
export function queryTipDistributions(payload) {
...
export function sumTipDistributionAmounts(payload) {
