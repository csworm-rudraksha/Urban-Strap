...
export function getStaffMember(payload) {
 ...
 */
export function deleteStaffMember(payload) {
 ...
 */
export function queryStaffMembers(payload) {
 ...
 */
export function countStaffMembers(payload) {
 ...
 */
export function connectStaffMemberToUser(payload) {
 ...
 */
export function searchStaffMembers(payload) {
 ...
 */
export function disconnectStaffMemberFromUser(payload) {
 ...
 */
export function assignWorkingHoursSchedule(payload) {
 ...
 */
export function bulkUpdateStaffMemberTags(payload) {
 ...
 * for a complete list of supported filters and sorting options.
 */
export function bulkUpdateStaffMemberTagsByFilter(payload) {
